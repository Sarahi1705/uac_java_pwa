<%-- 
    Document   : inicio
    Created on : 21 oct 2021, 19:42:17
    Author     : Sarah
--%>
...
<p class="title is-5">Registro de grupos</p>
<p class="subtitle">Mantenga el Control de sus grupos de alumnos</p>
</div>
</div>  
</div>
